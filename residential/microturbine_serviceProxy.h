...
#ifndef _microturbine_serviceProxy_h_
#define _microturbine_serviceProxy_h_
...
//! Proxy for component service energy.Microturbine.microturbine_service
class microturbine_serviceProxy: public microturbine_service
{
public:
  microturbine_serviceProxy();
  virtual ~microturbine_serviceProxy();
