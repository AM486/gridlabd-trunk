...
TIMESTAMP WH_as_service::sync(TIMESTAMP t0, TIMESTAMP t1)
{
	...
	int WHsyncResult = pwheater_service->WHsync(t0, t1, heating_element_capacity, temperature, tank_setpoint, tank_UA, water_demand, tank_volume, thermostat_deadband);
