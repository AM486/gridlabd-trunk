...
#ifndef _wheater_service_h_
#define _wheater_service_h_

#include <staff/common/IService.h>

// *interface.targetNamespace: http://tempui.org/energy.WHeater
// *interface.url: http://10.96.12.47:9090/axis2/services/staff.wsdl.Wsdl/get/energy.WHeater/energy.WHeater.wheater_service.wsdl
...
namespace WHeater
{
  ...
  //! wheater_service service
  // *serviceUri: http://10.96.12.47:9090/axis2/services/energy.WHeater.wheater_service
  // *soapVersion: 1.1
  // *targetNamespace: http://tempui.org/energy.WHeater
  class wheater_service: public staff::IService
  {
  public:
