...
public:
  ...
  {
    std::auto_ptr<microturbine_serviceProxy> tpProxy(new microturbine_serviceProxy);
    tpProxy->Init(sBaseUri + (sServiceName.empty() ? "microturbine_service" : sServiceName),
...
{
  staff::IService::Init("microturbine_service", sSessionId, sInstanceId);
  m_sServiceUri = !sServiceUri.empty() ? sServiceUri : "http://10.96.12.47:9090/axis2/services/microturbine_service";
