...
std::auto_ptr< ::microturbine_service > pmicroturbine_service(::staff::ServiceFactory::Inst().GetService< ::microturbine_service >());
...
int micro_service::init(OBJECT *parent)
{
	...
	price=pmicroturbine_service->microturbine_init();
...
TIMESTAMP micro_service::sync(TIMESTAMP t0, TIMESTAMP t1) 
{
	...
	VA_Out.Re() = pmicroturbine_service->microturbine_sync(CircuitA_V_Out_re, CircuitA_V_Out_im, CircuitB_V_Out_re, CircuitB_V_Out_im, CircuitC_V_Out_re, CircuitC_V_Out_im, LineA_V_Out_re, LineA_V_Out_im, LineB_V_Out_re, LineB_V_Out_im, LineC_V_Out_re, LineC_V_Out_im);
