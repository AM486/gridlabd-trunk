...
std::auto_ptr< ::windturbine_service > pwindturbine_service(::staff::ServiceFactory::Inst().GetService< ::windturbine_service >());
//std::auto_ptr< ::windturbine_server > pwindturbine_service(::staff::ServiceFactory::Inst().GetService< ::windturbine_server >());
...
TIMESTAMP wind_service::sync(TIMESTAMP t0, TIMESTAMP t1) 
{
	...
	// pCircuit_V_A_Re=pCircuit_V[0].Re(),  pCircuit_V_A_Im=pCircuit_V[0].Im(), pCircuit_V_B_Re=pCircuit_V[1].Re(), pCircuit_V_B_Im=pCircuit_V[1].Im(), pCircuit_V_C_Re=pCircuit_V[2].Re(),pCircuit_V_C_Im=pCircuit_V[2].Im()
