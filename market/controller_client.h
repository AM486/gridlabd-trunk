/** $Id: controller_client.h 4738 2014-07-03 00:55:39Z dchassin $
	Copyright (C) 2009 Battelle Memorial Institute
	@file controller_client.h
	@addtogroup controller_client
	@ingroup market
...
class controller_client : public gld_object {
public:
	controller_client(MODULE *);
	int create(void);
