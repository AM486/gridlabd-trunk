...
#ifndef _controllerserviceProxy_h_
#define _controllerserviceProxy_h_

#include <staff/client/ServiceClient.h>
#include "controllerservice.h"


//! Proxy for component service controllerservice
class controllerserviceProxy: public controllerservice
{
public:
